...
CLOSED: [2025-05-03 Sat 20:58]
** TODO create page or control to run rule against observation
** TODO create page or control to test rule against observation
** TODO create page to run all rules against observation/property
** TODO output rule results in pretty readable format
** TODO expose old/previous rule versions
** TODO update readme with all necessary content
